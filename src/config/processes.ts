...
export const PROCESSES: ProcessConfig[] = [
  ...
  { code: 'GTI', name: 'Tecnologias de la Información' },
...
export const PROCESS_DRIVE_LINKS: Record<string, string> = {
  ...
  'Tecnologias de la Información': 'https://drive.google.com/drive/folders/1-n3YtyrCGqust2kWx8-3KepFuv98WSKM?usp=sharing',
...
export const LEGACY_PROCESS_NAMES: Record<string, string[]> = {
  ...
  GSI: ['Tecnologias de la Información'],
  ...
  SIPLAG: ['SIPLAG'],
  SIT: ['Tecnologias de la Información'],
  ...
  GTI: ['Tecnologias de la Información'],
...
const PROCESS_NAME_ALIASES: Record<string, string> = {
  ...
  'Gestión de Tecnologías de la Información': 'Tecnologias de la Información',
